...
The Daylight Calendar Card requires only a list of calendar entities to get started, but a handful of core options let you tailor the card's behavior to your household. Most of these options are available in the [visual editor](/visual-editor) — you only need YAML if you prefer it or are version-controlling your dashboard.
